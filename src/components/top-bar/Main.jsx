        ...
        <>
            ...
            <div className="top-bar">
                ...
                <Dropdown className="intro-x w-8 h-8">
                    ...
                    >
                        <img alt="Midone Tailwind HTML Admin Template" src={userProfilePic} />
                    </DropdownToggle>
                    <DropdownMenu className="w-56">
                        <DropdownContent className="bg-primary text-white">
                            <DropdownHeader tag="div" className="!font-normal">
                                <div className="font-medium">{session.account.name}</div>
                            ...
                            <DropdownDivider className="border-white/[0.08]" />
                            <DropdownItem onClick={handleLogout} className="hover:bg-white/5">
