    ...
    <div className="min-h-screen bg-slate-100 dark:bg-darkmode-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="flex items-center mt-8 mb-8">
        <h2 className="intro-y text-lg font-medium mr-auto">
          {isPreview ? "Property Preview" : editData ? "Edit Property" : "Add New Property"}
        </h2>
      </div>
          ...
          >
            {({
              ...
              <Form>
                ...
                {currentStep === 1 && (
                  <div>
                    <div className="font-medium text-base">Property Details</div>
                    <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                      {/* Agent Email */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="agent_email" className="form-label">
                          Agent Email
                        </label>
                        <Field
                          type="email"
                      ...
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="property_type" className="form-label">
                          <FiHome className="inline mr-2" /> Property Type
                        </label>
                        <Field
                          as="select"
                          id="property_type"
                      ...
                      {/* Property Category */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="property_category" className="form-label">
                          Property Category
                        </label>
                        <Field
                          as="select"
                      ...
                      {/* Size Sqft */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="size_sqft" className="form-label">
                          Size (sqft)
                        </label>
                        <Field
                          type="number"
                      ...
                      {/* Carpet Area */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="carpet_area" className="form-label">
                          Carpet Area
                        </label>
                        <Field
                          type="number"
                      ...
                      {/* Buildup Area */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="buildup_area" className="form-label">
                          Buildup Area
                        </label>
                        <Field
                          type="number"
                ...
                {currentStep === 2 && (
                  <div>
                    <div className="font-medium text-base">Pricing & Features</div>
                    <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                      {/* Floor */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                      ...
                      {/* Total Floor */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="total_floor" className="form-label">
                          Total Floor
                        </label>
                        <Field
                          type="number"
                      ...
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="price" className="form-label">
                          <FiDollarSign className="inline mr-2" /> Price (INR)
                        </label>
                        <Field
                          type="number"
                          id="price"
                      ...
                      {/* Expected Value */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="expected_value" className="form-label">
                          Expected Value
                        </label>
                        <Field
                          type="number"
                      ...
                      {/* Builder */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="builder" className="form-label">
                          Builder
                        </label>
                        <Field
                          as="select"
                ...
                {currentStep === 3 && (
                  <div>
                    <div className="font-medium text-base">Additional Features</div>
                    <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                      {/* Covered Parking */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="covered_parking" className="form-label">
                          Covered Parking
                        </label>
                        <Field
                          as="select"
                      ...
                      {/* Open Parking */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="open_parking" className="form-label">
                          Open Parking
                        </label>
                        <Field
                          as="select"
                      ...
                      {/* Brokerage */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="brokerage" className="form-label">
                          Brokerage
                        </label>
                        <Field
                          as="select"
                      ...
                      {/* Property Age */}
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="property_age" className="form-label">
                          Property Age (years)
                        </label>
                        <Field
                          type="number"
                ...
                {currentStep === 4 && (
                  <div>
                    <div className="font-medium text-base">Media Upload</div>
                    <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                      {/* Images Upload */}
                      <div className="intro-y col-span-12">
                      ...
                      <div className="intro-y col-span-12 sm:col-span-6">
                        <label htmlFor="video" className="form-label">
                          <FiVideo className="inline mr-2" /> Video URL
                        </label>
                        <Field
                          type="text"
                          id="video"
                ...
                {currentStep === 5 && (
                  <div>
                    <div className="font-medium text-base">Review Your Listing</div>
                    <div className="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                      ...
                      <div className="intro-y col-span-12 md:col-span-6">
                        ...
                        <div className="space-y-2 text-slate-600 dark:text-slate-400 text-sm">
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Agent Email: </span>
                            {values.agent_email}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Type: </span>
                            {values.property_type}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Category: </span>
                          ...
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Size: </span>
                            {values.size_sqft} sqft
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Carpet Area: </span>
                            {values.carpet_area}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Buildup Area: </span>
                            {values.buildup_area}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">BHK: </span>
                            {values.bhk}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Floor: </span>
                            {values.floor}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Total Floor: </span>
                            {values.total_floor}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Facing: </span>
                            {values.facing}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Furnishing: </span>
                            {values.furnishing}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Price: </span>₹
                            {values.price}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Maintenance: </span>
                            ₹{values.maintenance}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Expected Value: </span>
                            ₹{values.expected_value}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Availability: </span>
                            {values.availability}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Builder: </span>
                            {values.builder}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Description: </span>
                            {values.description}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Covered Parking: </span>
                            {values.covered_parking}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Open Parking: </span>
                            {values.open_parking}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Bathroom: </span>
                            {values.bathroom}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Brokerage: </span>
                            {values.brokerage}
                          </div>
                          <div>
                            <span className="text-slate-800 dark:text-slate-200 font-medium">Property Age: </span>
                            {values.property_age}
                          </div>
                        </div>
                      </div>
                        ...
                        <div>
                          ...
                          <div className="mb-4">
                            ...
                            {imageFiles.length > 0 ? (
                              ...
                              <p className="text-slate-500 dark:text-slate-400">No images added</p>
                            )}
                          </div>
                          <div>
                            <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">Video</p>
                            {values.video ? (
